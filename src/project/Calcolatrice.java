...
public class Calcolatrice extends Application{
	...
	public static String OP1ERATION = "";
	...
	public void start(Stage stage){
		...
		listButton.get(0).setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent event) {
				if(RESULT || OP1ERATION.equals("error")) {
					OP1ERATION = "";
					OP1 = String.valueOf(number0);
					OP2 = "";
					RESULT = false;
					SYMBOL = "";
					display.setText(OP1ERATION);
				}
				else {
					if(SYMBOL.equals("")) {
						OP1 += number0;
		...
		listButton.get(12).setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent event) {
				if(SYMBOL.equals("")) {
					...
					OP1ERATION = OP1ERATION.substring(0, OP1ERATION.length() - 1);
					OP1ERATION += "+";
					SYMBOL = "+";
				}
				OP2 = "";
			...
			public void handle(ActionEvent event) {
				...
				if(!RESULT) {
					if(!OP1.equals("") || !OP2.equals("")) {
						if(!SYMBOL.equals("") && (OP1ERATION.substring(OP1ERATION.length()-1, OP1ERATION.length()).equals(SYMBOL))) {
							SYMBOL = "";
							OP2 = "";
							OP1ERATION = OP1ERATION.substring(0, OP1ERATION.length()-1);
						}
